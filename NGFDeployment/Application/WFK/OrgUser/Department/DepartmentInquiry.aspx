<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentInquiry.aspx.cs"
    Inherits="ITS.WebFramework.PermissionManagement.WebFormUI.OrgUser.Department.DepartmentInquiry" %>

<%@ Import Namespace="ITS.WebFramework.PermissionManagement.Common.PermissionConst" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Department Inquiry</title>
</head>
<body>
    ...
    <script type="text/javascript" src="DepartmentInquiry.js">
    </script>
    </form>
</body>
</html>

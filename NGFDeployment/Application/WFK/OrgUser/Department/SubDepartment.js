...
$(function () {
    ...
    var baseurl = "GetSubDepartment.ashx?" + $.param({ First: true, DepartmentId: pageParameterDepartmentId });
    $('#treegrid1').treegrid({
        url: baseurl,
        idField: 'Id',
        ...
        onBeforeExpand: function (rowData) {
            $("#treegrid1").treegrid("options").url = "GetSubDepartment.ashx?" + $.param({ First: false, DepartmentId: rowData.Id });
            return true;
        },

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgMaintain.aspx.cs" Inherits="ITS.WebFramework.PermissionManagement.WebFormUI.OrgUser.Org.OrgMaintain" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Org Maintain</title>
</head>
<body>
    ...
    <div id="divMainContent" style="width: 98%;">
        <table width="100%">
            ...
            <tr>
                <td width="20%">
                    <span class="Label">Org Admin Role</span>
                </td>
                <td width="3%">
                </td>
                <td width="60%">
                    <input type="text" maxlength="100" class="TextBox" id="textOrgAdminRole" />
                </td>
                <td>
    ...
    <script type="text/javascript" src="OrgMaintain.js">
    </script>
    </form>
</body>
</html>

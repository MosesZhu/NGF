...
function inquiryData() {
    ...
    $('#datagrid1').datagrid({
        ...
        columns: [[
                    ...
                    { field: 'system', title: 'System', width: 200, halign: 'center' },
                    ...
                    { field: 'process', title: 'Process', width: 200, halign: 'center' },
                    { field: 'time_slice', title: 'Time Slice', width: 200, halign: 'center' },
                    { field: 'last_datetime', title: 'Last Datetime', width: 200, halign: 'center' },
...
function buttonSave_click() {
    var listBaseConfigJobDTO = $('#datagrid1').datagrid("getChecked");
    ...
    $.qajax({
        url: "ConfigJobService.asmx/ImportConfigJob",

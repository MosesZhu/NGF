<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfigJobInquiry.aspx.cs"
    Inherits="ITS.WebFramework.PermissionManagement.WebFormUI.Config.JobSetting.ConfigJobInquiry" %>
...
<body>
        ...
        <div id="divQueryConditions" class="easyui-panel" title="Query Conditions" data-options="collapsible:true">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td width="35%">
                        <input type="text" maxlength="250" id="textProcess" class="TextBox" />
                    </td>
                    <td width="5%">
                    </td>
                </tr>
    ...
    <script type="text/javascript" src="ConfigJobInquiry.js">
    </script>
    </form>
</body>
</html>

...
function inquiryData() {
    ...
    $('#datagrid1').datagrid({
        ...
        columns: [[
                    ...
                    { field: 'system_id', title: 'System Id', width: 200, halign: 'center' },
                    { field: 'parent_function_id', title: 'Parent Function Id', width: 200, halign: 'center' },
                    { field: 'code', title: 'Code', width: 200, halign: 'center' },
                    { field: 'name', title: 'Name', width: 200, halign: 'center' },
                    { field: 'description', title: 'Description', width: 200, halign: 'center' },
                    { field: 'assembly', title: 'Assembly', width: 200, halign: 'center' },
                    { field: 'form_class', title: 'Form Class', width: 200, halign: 'center' },
                    { field: 'navigate_url', title: 'Navigate Url', width: 200, halign: 'center' },
                    { field: 'target', title: 'Target', width: 200, halign: 'center' },
                    { field: 'instance_type', title: 'Instance Type', width: 200, halign: 'center' },
                    { field: 'is_public', title: 'Is Public', width: 200, halign: 'center' },
                    { field: 'system_icon_name', title: 'System Icon Name', width: 200, halign: 'center' },
                    { field: 'custom_icon_url', title: 'Custom Icon Url', width: 200, halign: 'center' },
                    { field: 'node_type', title: 'Node Type', width: 200, halign: 'center' },
                    { field: 'node_level', title: 'Node Level', width: 200, halign: 'center' },
                    { field: 'node_level_code', title: 'Node Level Code', width: 200, halign: 'center' },
...
function buttonSave_click() {
    var listBaseFunctionDTO = $('#datagrid1').datagrid("getChecked");
    ...
    $.qajax({
        url: "FunctionService.asmx/ImportFunction",

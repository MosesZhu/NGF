...
function inquiryData() {
    ...
    $('#datagrid1').datagrid({
        ...
        columns: [[
                    ...
                    { field: 'type', title: 'Type', width: 200, halign: 'center' },
...
function buttonSave_click() {
    var listBaseConfigGlobalResourceDTO = $('#datagrid1').datagrid("getChecked");
    ...
    $.qajax({
        url: "ConfigGlobalResourceService.asmx/ImportConfigGlobalResource",
